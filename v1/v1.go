...
// Get the champions of the latest version and write them to a file
// and also write the latest version to a file
...
// Get the champions of a specific version
...
// Get a champion by id and version
